...
Reservation::Reservation(int CIN,int resID,int poste,QString datte){
    this->CIN=CIN;
    this->resID=resID;
    this->poste=poste;
    this->datte=datte;
...
bool Reservation::ajouter()
{
    ...
    query.prepare("insert into reservation(CIN,datte,resID,poste) values ('"+res1+"','"+datte+"','"+res+"','"+res2+"')");
