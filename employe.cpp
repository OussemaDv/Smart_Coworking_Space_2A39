...
void employe::setpwd(QString pwd)
{
    this->pwd=pwd;
}
...
bool employe::supprimer_emp(int id)
{
...
bool employe::modifier_emp(int id)
{
    QSqlQuery query;
...
QSqlQueryModel * employe::afficher_emp()
{
...
QSqlQueryModel * employe::rechercher_id_emp(int ID)
{
    QSqlQueryModel * model=new QSqlQueryModel();
    QString res= QString::number(ID);
...
QSqlQueryModel * employe::rechercher_ID_emp(QString rech, QString rech_1)
{
    QSqlQueryModel * model=new QSqlQueryModel();
...
QSqlQueryModel* employe::rechercherID_emp(QString recherche)
{
    QSqlQueryModel* model=new QSqlQueryModel();
